/* jQuery lightzoom v1.1.0 (c) 2020 Aleksey Savin */
(function($,window,document,undefined){"use strict";var pluginName="lightzoom";var defaults={boxClass:"",speed:400,imgPadding:10,overlayOpacity:"0.5",overlayColor:"",viewTitle:!1,titleColor:"",isOverlayClickClosing:!1,isWindowClickClosing:!1,isEscClosing:!1};var html='<div id="lz-container">\<div id="lz-box">\<div id="lz-overlay"></div>\</div>\<div id="lz-loading-center">\<div class="lz-loading-center-box">\<div class="lz-object" id="lz-object_one"></div>\<div class="lz-object" id="lz-object_two"></div>\<div class="lz-object" id="lz-object_three"></div>\</div>\</div>\</div>';function Plugin(element,options){this.element=element;this.settings=$.extend({},defaults,options);this._defaults=defaults;this._name=pluginName;this.init()}
...
$('#lz-box img').css(imgCss)},setDim:function(){var width,height,imgCss={};var winWidth=window.innerWidth?window.innerWidth:$(window).width();var winHeight=window.innerHeight?window.innerHeight:$(window).height();if(winWidth>winHeight){width="95%";height="80%"}else{width="80%";height="100%"}
if('onorientationchange' in window){window.addEventListener('orientationchange',function(){if(window.orientation===0){width="80%";height="100%"}else if(window.orientation===90||window.orientation===-90){width="95%";height="80%"}},!1)}
imgCss={maxWidth:width,maxHeight:height,};$('#lz-box img').css(imgCss)},closeZoom:function(){var $this=this;$('#lz-container').fadeOut($this.settings.speed,function(){$this.destroy()})},resize:function(){var $this=this;$(window).resize(function(){$this.setDim()})},destroy:function(){$('#lz-container').remove()},});$.fn[pluginName]=function(options){return this.each(function(){if(!$.data(this,"plugin_"+pluginName)){$.data(this,"plugin_"+pluginName,new Plugin(this,options))}})}})(jQuery,window,document)