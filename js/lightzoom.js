/* jQuery lightzoom v1.1.0 (c) 2020 Aleksey Savin | asavin.work@yandex.ru */
...
imgCss = {};
if ( this.settings.viewTitle && title ) {
padding = this.settings.imgPadding + "px " + this.settings.imgPadding + "px " + ( this.settings.imgPadding + 0 ) + "px " + this.settings.imgPadding + "px";
} else {
